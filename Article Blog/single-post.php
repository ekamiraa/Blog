      ...
      <section class="single-post-content">
        <div class="container">
          <div class="row">
            ...
            <!-- Mengambil Id_article -->
            <?php
              include("connect/koneksi.php");

              // Ambil id_article dari parameter URL
              if (isset($_GET['id_article'])) {
                  $id_article = $_GET['id_article'];
              } else {
                  // Jika id_article tidak ada, arahkan pengguna ke halaman lain
                  header("Location: index.php");
                  exit();
              }

              // Query untuk mengambil data artikel berdasarkan id_article
              ...
              <div class="single-post">
                <figure class="my-4">
                  ...
                  <style>
                          .custom-image {
                              width: 90%;
                              height:550px; /* Ubah nilai ini sesuai kebutuhan Anda */
                              object-fit: cover;
                          }
                      </style>
                </figure>
                ...
                <div class="d-flex align-items-center author">
                  <div class="name">
                    <h3 class="m-0 p-0">Penulis: <?= $penulis ?></h3>
                  </div>
                </div>
              </div>
            ...
            <?php
                ...
                // Jika artikel tidak ditemukan, arahkan pengguna ke halaman lain
                header("Location: index.php");
                exit();
            }
            ?>
